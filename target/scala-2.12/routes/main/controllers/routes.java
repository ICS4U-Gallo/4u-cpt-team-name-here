...
public class routes {
  ...
  public static final controllers.ReverseQuadraticController QuadraticController = new controllers.ReverseQuadraticController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseQuadraticController QuadraticController = new controllers.javascript.ReverseQuadraticController(RoutesPrefix.byNamePrefix());
  }
